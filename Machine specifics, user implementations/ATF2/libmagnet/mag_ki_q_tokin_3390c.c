...
//F	data cur( 8) / 139.0 /, fld( 8) / 23.0 /
	...
	cur[ 2-1] =  10.00; fld[ 2-1] =  0.58*5.0; 
	cur[ 3-1] =  20.00; fld[ 3-1] =  1.10*5.0; 
	cur[ 4-1] =  30.00; fld[ 4-1] = 1.62*5.0; 
	cur[ 5-1] =  40.00; fld[ 5-1] = 2.16*5.0; 
	cur[ 6-1] = 50.00; fld[ 6-1] = 2.65*5.0; 
	cur[ 7-1] = 60.00; fld[ 7-1] = 3.19*5.0; 
	cur[ 8-1] = 70.00; fld[ 8-1] = 3.67*5.0; 
	cur[ 9-1] = 80.00; fld[ 9-1] = 4.24*5.0; 
	cur[ 10-1] = 90.00; fld[ 10-1] = 8.52*5.0; 
	cur[ 11-1] = 100.00; fld[ 11-1] = 9.33*5.0; 
