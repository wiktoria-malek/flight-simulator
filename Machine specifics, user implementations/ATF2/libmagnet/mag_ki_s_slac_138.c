...
//F!
//F!	----------------------------------------------------------------------
//F	integer*4 function mag_ki_s_slac_138
...
//F	parameter r0 = 0.0254*(1.38/2.0)
	const float r0 = 0.0254*(1.38/2.0);

//F	data cur(01) /  0.0 /, fld(01) / 0.000000 /
//F	data cur(02) /  0.5 /, fld(02) / 0.006977 /
//F	data cur(03) /  1.0 /, fld(03) / 0.015456 /
//F	data cur(04) /  1.5 /, fld(04) / 0.023927 /
//F	data cur(05) /  2.0 /, fld(05) / 0.032388 /
//F	data cur(06) /  2.5 /, fld(06) / 0.040839 /
//F	data cur(07) /  3.0 /, fld(07) / 0.049278 /
//F	data cur(08) /  3.5 /, fld(08) / 0.057704 /
//F	data cur(09) /  4.0 /, fld(09) / 0.066116 /
//F	data cur(10) /  4.5 /, fld(10) / 0.074513 /
//F	data cur(11) /  5.0 /, fld(11) / 0.082892 /
//F	data cur(12) /  5.5 /, fld(12) / 0.091252 /
//F	data cur(13) /  6.0 /, fld(13) / 0.099591 /
//F	data cur(14) /  6.5 /, fld(14) / 0.107904 /
//F	data cur(15) /  7.0 /, fld(15) / 0.116190 /
//F	data cur(16) /  7.5 /, fld(16) / 0.124444 /
//F	data cur(17) /  8.0 /, fld(17) / 0.132662 /
//F	data cur(18) /  8.5 /, fld(18) / 0.140840 /
//F	data cur(19) /  9.0 /, fld(19) / 0.148971 /
//F	data cur(20) /  9.5 /, fld(20) / 0.157051 /
//F	data cur(21) / 10.0 /, fld(21) / 0.165073 /
...
//F	end if
	...
	if( firsttime ){
		...
		cur[ 2-1] =  0.5; fld[ 2-1] = 0.006977; //
		cur[ 3-1] =  1.0; fld[ 3-1] = 0.015456; //
		cur[ 4-1] =  1.5; fld[ 4-1] = 0.023927; //
		cur[ 5-1] =  2.0; fld[ 5-1] = 0.032388; //
		cur[ 6-1] =  2.5; fld[ 6-1] = 0.040839; //
		cur[ 7-1] =  3.0; fld[ 7-1] = 0.049278; //
		cur[ 8-1] =  3.5; fld[ 8-1] = 0.057704; //
		cur[ 9-1] =  4.0; fld[ 9-1] = 0.066116; //
		cur[10-1] =  4.5; fld[10-1] = 0.074513; //
		cur[11-1] =  5.0; fld[11-1] = 0.082892; //
		cur[12-1] =  5.5; fld[12-1] = 0.091252; //
		cur[13-1] =  6.0; fld[13-1] = 0.099591; //
		cur[14-1] =  6.5; fld[14-1] = 0.107904; //
		cur[15-1] =  7.0; fld[15-1] = 0.116190; //
		cur[16-1] =  7.5; fld[16-1] = 0.124444; //
		cur[17-1] =  8.0; fld[17-1] = 0.132662; //
		cur[18-1] =  8.5; fld[18-1] = 0.140840; //
		cur[19-1] =  9.0; fld[19-1] = 0.148971; //
		cur[20-1] =  9.5; fld[20-1] = 0.157051; //
		cur[21-1] = 10.0; fld[21-1] = 0.165073; //
...
//F	mag_ki_s_slac_138 = mag_ki_control
//F	1		    (
