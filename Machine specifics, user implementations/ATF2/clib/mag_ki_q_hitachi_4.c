...
//F!
//F!	----------------------------------------------------------------------
//F	integer*4 function mag_ki_q_hitachi_4
...
//F!
//F!	(effective length)
//F!	    integrated field strength = 746255 gauss*mm.
//F!	    field strength at z=0 is 3754.83 gauss*mm, then eff=0.198745 meter.
//F!
//F!	parameter
//F!	    coils:  based on the drawings #310q431-360, 96-01-11.
//F!
//F!	history
...
//F        parameter eff_length = 0.198745
	const float eff_length = 0.198745;

//F	data cur(01) /    0.00000 /, fld(01) /    0.00000 /
//F	data cur(02) /   20.20000 /, fld(02) /    4.61200 /
//F	data cur(03) /   40.20000 /, fld(03) /    9.20100 /
//F	data cur(04) /   60.40000 /, fld(04) /   13.85800 /
//F	data cur(05) /   80.40000 /, fld(05) /   18.44000 /
//F	data cur(06) /  100.00000 /, fld(06) /   22.88400 /
//F	data cur(07) /  120.20000 /, fld(07) /   27.46400 /
//F	data cur(08) /  140.20000 /, fld(08) /   31.92500 /
//F	data cur(09) /  160.20000 /, fld(09) /   36.38600 /
//F	data cur(10) /  180.00000 /, fld(10) /   40.72600 /
//F	data cur(11) /  200.39999 /, fld(11) /   45.14300 /
//F	
	cur[ 1-1] =    0.00000; fld[ 1-1] =    0.00000; 
	cur[ 2-1] =   20.20000; fld[ 2-1] =    4.61200; 
	cur[ 3-1] =   40.20000; fld[ 3-1] =    9.20100; 
	cur[ 4-1] =   60.40000; fld[ 4-1] =   13.85800; 
	cur[ 5-1] =   80.40000; fld[ 5-1] =   18.44000; 
	cur[ 6-1] =  100.00000; fld[ 6-1] =   22.88400; 
	cur[ 7-1] =  120.20000; fld[ 7-1] =   27.46400; 
	cur[ 8-1] =  140.20000; fld[ 8-1] =   31.92500; 
	cur[ 9-1] =  160.20000; fld[ 9-1] =   36.38600; 
	cur[10-1] =  180.00000; fld[10-1] =   40.72600; 
	cur[11-1] =  200.39999; fld[11-1] =   45.14300; 

//F        efflen = eff_length 
	*efflen = eff_length;

//F	mag_ki_q_hitachi_4 = mag_ki_control
//F	1		    (
