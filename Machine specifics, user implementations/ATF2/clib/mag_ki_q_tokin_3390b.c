...
//F        parameter eff_length = 0.07890677
	...
	const float eff_length = 0.19658879;
...
//F	data cur( 8) / 139.0 /, fld( 8) / 23.0 /
	...
	cur[ 2-1] =  10.00; fld[ 2-1] =  1.05*5.0; 
	cur[ 3-1] =  20.00; fld[ 3-1] =  2.00*5.0; 
	cur[ 4-1] =  30.00; fld[ 4-1] = 2.93*5.0; 
	cur[ 5-1] =  40.00; fld[ 5-1] = 3.85*5.0; 
	cur[ 6-1] = 50.00; fld[ 6-1] = 4.84*5.0; 
	cur[ 7-1] = 60.00; fld[ 7-1] = 5.78*5.0; 
	cur[ 8-1] = 70.00; fld[ 8-1] = 6.74*5.0; 
	cur[ 9-1] = 80.00; fld[ 9-1] = 7.60*5.0; 
