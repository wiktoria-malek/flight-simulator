...
//F	data cur( 8) / 139.0 /, fld( 8) / 23.0 /
	...
	cur[ 2-1] =  20.0; fld[ 2-1] =  3.4; 
	cur[ 3-1] =  40.0; fld[ 3-1] =  6.8; 
	cur[ 4-1] =  60.0; fld[ 4-1] = 10.0; 
	cur[ 5-1] =  80.0; fld[ 5-1] = 13.2; 
	cur[ 6-1] = 100.0; fld[ 6-1] = 16.6; 
	cur[ 7-1] = 120.0; fld[ 7-1] = 19.8; 
	cur[ 8-1] = 139.0; fld[ 8-1] = 23.0; 
