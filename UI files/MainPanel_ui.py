...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.interfaces_buttons_layout = QVBoxLayout()
        ...
        self.sysid_interface_button = QPushButton(self.centralwidget)
        ...
        self.compute_matrix_button = QPushButton(self.centralwidget)
        ...
        self.bba_interface_button = QPushButton(self.centralwidget)
        ...
        self.emittance_interface_button = QPushButton(self.centralwidget)
        ...
        self.knobs_interface_button = QPushButton(self.centralwidget)
        ...
        self.horizontal_layout.addLayout(self.interfaces_buttons_layout)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sysid_interface_button.setText(QCoreApplication.translate("MainWindow", u"System Identification", None))
